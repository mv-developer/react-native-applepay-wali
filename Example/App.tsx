...
} from "react-native-applepay-wali";
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>
          Welcome to react-native-applepay-wali!
        </Text>
        <TouchableOpacity
          style={styles.button}
          onPress={() => this.payWithApplePay(ApplePay.SUCCESS)}
        >
          <Text style={styles.buttonText}>Buy with Apple Pay (SUCCESS)</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => this.payWithApplePay(ApplePay.FAILURE)}
        >
